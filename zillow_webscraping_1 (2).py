...
Original file is located at
    https://colab.research.google.com/drive/1-U_6wtI01v9elNtkNI7Mbf6uInphPZYs
...
if city == 'Austin':
    ...
    url_c = 'https://www.zillow.com/homes/Houston,-TX_rb/'
elif city == 'Philadelphia':
    url_c = 'https://www.zillow.com/homes/Philadelphia,-PA_rb/'
elif city == 'Phoenix':
    url_c = 'https://www.zillow.com/homes/Phoenix,-AZ_rb/'
elif city == 'Portland':
    url_c = 'https://www.zillow.com/homes/Portland,-OR_rb/'
elif city == 'Birmingham':
    url_c = 'https://www.zillow.com/homes/Birmingham,-AL_rb/'
elif city == 'Nashville':
    url_c = 'https://www.zillow.com/homes/Nashville,-TN_rb/'
elif city == 'Oklahoma City':
    url_c = 'https://www.zillow.com/homes/Oklahoma-City,-OK_rb/'
elif city == 'Charlotte':
    url_c = 'https://www.zillow.com/homes/Charlotte,-NC_rb/'
elif city == 'Richmond':
    url_c = 'https://www.zillow.com/homes/Richmond,-VA_rb/'
elif city == 'Baltimore':
    url_c = 'https://www.zillow.com/homes/Baltimore,-MD_rb/'
else: # default city
    url_c = 'https://www.zillow.com/homes/Austin,-TX_rb/'

# Dictionary for City & State
c_s = {'Atlanta': 'GA', 'Birmingham': 'AL', 'Austin': 'TX', 'Boston': 'MA', 'Baltimore': 'MD', 'Charlotte': 'NC', 'Chicago': 'IL', 
       'Houston': 'TX', 'Las Vegas': 'NV', 'Los Angeles': 'CA', 'Miami': 'FL', 'Nashville': 'TN', 'New York': 'NY', 
       'Oklahoma City': 'OK', 'Philadelphia': 'PA', 'Portland': 'OR', 'Phoenix': 'AZ', 'Richmond': 'VA',
